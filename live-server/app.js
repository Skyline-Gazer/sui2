...
const editorDir = path.resolve(__dirname, 'editor/dist')

// place to store data generated by live-server
// resolve to an absolute path (relative values are resolved against cwd)
const dataDir = path.resolve(process.env.DATA_DIR || 'data')
const dataFilePath = path.resolve(dataDir, 'data.json')
console.log('dataFilePath', dataFilePath)
const outDir = path.resolve(dataDir, 'dist')
